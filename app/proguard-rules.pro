...
# EasyAdapter rules
-keepclassmembers class * extends com.InfinityTides.petfinder.easyadapter.ItemViewHolder {
    public <init>(...);
 }
...
-keepclassmembers class com.InfinityTides.petfinder.data.model.** {
...
-keepclassmembers class com.InfinityTides.petfinder.data.remote.RibotsService$** {
    !static !private <fields>;
}
